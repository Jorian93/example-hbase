...
import com.example.authenticatingldap.core.User;
...
public class HbaseApplication {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.setProperty("HADOOP_HOME", "/usr/local/src/hadoop/hadoop-2.10.0");
        try {
    ...
    public static Connection initHbase() throws IOException {
        ...
        configuration.set("hbase.zookeeper.quorum", "47.108.129.143");
        // 集群配置↓
        // configuration.set("hbase.zookeeper.quorum",
        // "101.236.39.141,101.236.46.114,101.236.46.113");
        configuration.set("hbase.master", "47.108.129.143:60010");
